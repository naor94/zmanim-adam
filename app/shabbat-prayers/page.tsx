...
export default async function ShabbatPrayersPage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="max-w-4xl mx-auto p-4">
        <h2 className="text-xl font-bold text-cyan-800 mb-4 text-center">מניני שבת ויו&quot;ט</h2>
        <div className="card">
